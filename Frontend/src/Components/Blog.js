    ...
    <div className="card-columns">
      <div className="card">
        ...
        <div className="card-body">
		  ...
		  <a href="" className="btn btn-outline btn-sm blog-btn">Read More</a>
          <a href="" className="btn btn-outline-danger btn-sm"><i className="icon-heart-o"></i></a>
      </div>
        </a>
      </div>
      <div className="card">
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p id="card-text">Amet commodi deleniti enim laboriosam odio placeat praesentium quis ratione rerum suscipit.</p>
          <a href="" className="btn btn-outline btn-sm">Read More</a>
          <a href="" className="btn btn-outline-danger btn-sm"><i className="icon-heart-o"></i></a>
		</div>
        </a>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <h5 className="card-title">Lorem ipsum dolor sit amet, consectetur.</h5>
          <p id="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
          <a href="" className="btn btn-outline btn-sm">Read More</a>
          <a href="" className="btn btn-outline-danger btn-sm"><i className="icon-heart-o"></i></a>
		</div>
        </a>
      ...
      <div className="card">
        ...
        <div className="card-body">
          <h5 className="card-title">Lorem ipsum dolor sit amet.</h5>
          <p id="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. At, consequatur culpa cumque deserunt dignissimos error explicabo fugiat harum ipsam magni minus mollitia nemo perferendis qui repellendus rerum saepe vel voluptate voluptatem voluptatum!
      ...
      <div className="card">
        ...
        <div className="card-body">
          ...
          <p id="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque commodi debitis eaque explicabo fuga maiores necessitatibus, neque omnis optio vel!</p>
          <a href="" className="btn btn-outline btn-sm">Read More</a>
          <a href="" className="btn btn-outline-danger btn-sm"><i className="icon-heart-o"></i></a>
		</div>
        </a>
